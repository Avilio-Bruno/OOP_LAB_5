...
// Потенциальная утечка памяти, но из-за умного указателя unique утечки скорее всего не будет
Base& func5() {
	cout << "Base& func5()\n";
	Base obj;
	return obj;
...
// Потенциальная утечка памяти. (delete &obj6) из-за того что объект не удалится при выходе из функции
void base() {
